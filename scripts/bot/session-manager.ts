 ...
 * Production-ready: prevents memory leaks, thread-safe operations
 */

import { logDebug, logWarn } from './logger';
import type { BlogPostData } from './blog-generator';
import type { NewsItem } from './news-scanner';
...
// Singleton instance (initialized in main.ts with config)
